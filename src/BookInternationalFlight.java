...
public class BookInternationalFlight extends JFrame {
	...
	public BookInternationalFlight() {
		...
		String[] columns = {"Flight student_id", "Time", "lessonDate", "Daparture Destination",
				...
				if (table.getSelectedRowCount()==1)
				{
					...
					int slctClass = Integer.valueOf(userchoice);
						...
						switch (slctClass)
						{
							...
							default:
							{
								JOptionPane.showMessageDialog(null, "You entered an invalid userIn. Try again");
								break;
							}
						}
					}
		...
		JButton btnNewButton_2 = new JButton("View Ticket lesson_cost");

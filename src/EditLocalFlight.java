...
public class EditLocalFlight extends JFrame {
	...
	public EditLocalFlight() {
		...
		JLabel lblNewLabel_1 = new JLabel("Flight student_id");
		...
		JLabel lblNewLabel_3 = new JLabel("Flight lessonDate");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(null, "Please enter integer userIn for Economy Seats.");
				}
				else if(businessSeats.getText().matches("^\\d+(\\.\\d+)?")==false)
				{
					JOptionPane.showMessageDialog(null, "Please enter integer userIn for Business Seats.");
				}
				else if(distance.getText().matches("^\\d+(\\.\\d+)?")==false)
				{
					JOptionPane.showMessageDialog(null, "Please enter integer userIn for Time Duration.");
				}
